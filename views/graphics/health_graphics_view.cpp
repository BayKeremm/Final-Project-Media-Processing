#include "health_graphics_view.h"
#include <QFont>
#include <QPainter>
#include <QPainterPath>

HealthGraphicsView::HealthGraphicsView(MainWindow *parent)
    : QProgressBar(parent) {
  setGeometry(360, 10, 220, 30);
  setMaximum(100);
}

void HealthGraphicsView::paintEvent(QPaintEvent *) {
...
void HealthGraphicsView::draw(QPainter *painter, QRect rect, int w) {
...
void HealthGraphicsView::drawEllipticalRectangle(QPainter *painter, QRect rect,
                                                 int w) {
